...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220216_sinankoltukyikama_98665a7f3e187ac28436_20220216185107_archive.zip';
	const ARCHIVE_SIZE		 = '88537912';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '98665a7-16185107';
    const SECONDARY_PACKAGE_HASH = '4c0016e-16185107';
	const VERSION			 = '1.4.4';
